...
import FeeTypeTable from "@/components/dashboard/accounting/feeTypeTable";
import FeeTypeForm from "@/components/dashboard/accounting/feeTypeForm";
    ...
    <div className="space-y-3 font-mukta">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <PageHeader
          ...
          description="Create and categorize different types of fees your institution collects."
        />
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <ThemedInput
              type="text"
              placeholder="Search fee type or code..."
              value={searchQuery}
