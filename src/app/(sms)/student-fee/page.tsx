...
// Components
import StudentFeeTable from "@/components/dashboard/accounting/studentFeeTable";
import StudentFeeForm from "@/components/dashboard/accounting/studentFeeForm";
    ...
    <div className="space-y-3 font-mukta">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <PageHeader
          ...
          description="Manage and track individual student fee assignments and payment status."
        />
